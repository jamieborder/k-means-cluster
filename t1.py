...
entities = mesh.getEntities()




# Nodes = mesh.getNodes()[1].reshape((-1,3))
# FaceNodeIds = mesh.getElementFaceNodes(2,3).astype(int)
# #  EdgeNodeIds = mesh.getElementEdgeNodes(2,3).astype(int)
# 
# for i in range(len(FaceNodeIds)-1):
#     #  print(i,FaceNodeIds[i])
#     a = Nodes[FaceNodeIds[i  ]-1]
#     b = Nodes[FaceNodeIds[i+1]-1]
#     plt.plot([a[0],b[0]],[a[1],b[1]],'b-')
# 
# #  for i in range(len(EdgeNodeIds)-1):
#     #  #  print(i,EdgeNodeIds[i])
#     #  a = Nodes[EdgeNodeIds[i  ]-1]
#     #  b = Nodes[EdgeNodeIds[i+1]-1]
#     #  plt.plot([a[0],b[0]],[a[1],b[1]],'r--')
# 
# plt.plot(Nodes[:,0],Nodes[:,1],'bo',mfc='w')
# 
